...
dbGetQuery(mydb,"select code_module as module, code_presentation as presentation, id_student from studentInfo order by id_student desc limit 20;")

#Read the other table according to a condition of one of the variables.
dbGetQuery(mydb,"select * from studentAssessment where id_assessment = 1752 limit 10;")
```
...
dbGetQuery(mydb, "insert into studentAssessment (id_assessment, id_student, date_submitted) VALUES ('99999', '666', '20');")
dbGetQuery(mydb, "SELECT * FROM studentAssessment where id_student=666;")
dbGetQuery(mydb, "UPDATE studentAssessment SET score = '100' WHERE id_student = 666;")
dbGetQuery(mydb, "SELECT * FROM studentAssessment where id_student=666;")
dbGetQuery(mydb, "DELETE FROM studentAssessment WHERE id_student = 666;")
